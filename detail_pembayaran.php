                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
										...
										<td><?php echo number_format("".$rows['jumlah_tf']."",0); ?></td>
										...
										<td><a href="update_verifiksi.php?id_pembelian=<?php echo $rows['id_pembelian'];?>"><img src="img/tick.png" width="30" height="40" onclick ="return confirm('Anda yakin ingin mengubah Status dan menyetujui nya  ?');" title="Verifikasi"></td>
										<td><a href="update_tolak.php?id_pembelian=<?php echo $rows['id_pembelian'];?>"><img src="img/cancel.png" width="30" height="30" onclick ="return confirm('Anda yakin ingin mengubah Status dan menolak nya ?');" title="Tolak"></td>
											</tr>
											<?php }?>
									</table>
                                </div>
