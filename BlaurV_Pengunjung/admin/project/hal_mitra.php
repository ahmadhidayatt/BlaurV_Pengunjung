        ...
        <body class="nav-md">
            <div class="container body">
                ...
                <div class="right_col" role="main">
                    <div class="col-lg-12">
                        <h1>Halaman <small>Mitra</small></h1>
                        <table width="900">
                            <tr>
                    ...
                    <div class="row">
                        <div style="margin-top: 40px;" class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <?php
                                    $tampil = ("select * from tb_pemesanan where nama_lapangan='$nama' and  status = 'Sedang di cek'");
                                        ...
                                        <tbody>
                                            <?php while ($row = mysqli_fetch_array($result)) {
                                                ?> <tr>
                                                    ...
                                                    <td>
                                                        <center><img style="width: 20%; height: 20%" src="<?php echo "../../file/" . $row['bukti']; ?>"></center>
                                                    </td>
                                                    <td><a class="btn btn-sm btn-primary" href="../../proses/download.php?file=<?php echo $row['bukti']; ?>"><i class="fa fa-edit"></i> Download</a>
                                                        <a class="btn btn-sm btn-primary" href="hal_mitra_update_status.php?hal=edit&kd=<?php echo $row['id_mitra']; ?>"><i class="fa fa-edit"></i> Update trans</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
