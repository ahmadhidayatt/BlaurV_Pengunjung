                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
										...
										<td><a href="update_kehadiran.php?id_pembelian=<?php echo $rows['id_pembelian'];?>"><img src="img/tick.png" width="30" height="40" onclick ="return confirm('Anda yakin ingin masuk ke stadion sekarang ?');" title="Masuk"></td>
										<td><a href="update_gahadir.php?id_pembelian=<?php echo $rows['id_pembelian'];?>"><img src="img/cancel.png" width="30" height="30" onclick ="return confirm('Anda yakin ingin mengubah Status dan menolak nya ?');" title="Tolak"></td>
											</tr>
											<?php }?>
